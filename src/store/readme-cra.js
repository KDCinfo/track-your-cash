const imgUrl1 = `http://facebook.github.io/jest/img/blog/15-watch.gif`,
      imgUrl2 = `http://i.imgur.com/7CIAWpB.gif`,
      imgUrl3 = `http://i.imgur.com/5bFhnTS.png`

const myMarkR = `## CREATE-REACT-APP

This project was bootstraped using Create-React-App.

Below you will find some information about CRA.
